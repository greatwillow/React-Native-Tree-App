...
export const plantersSelectedInstance = createSelector(
  ...
  orm.createSelector((orm, selectedPlanterId) => {
    if((selectedPlanterId !== null) && (selectedPlanterId !== undefined) && (selectedPlanterId !== 0)) {
...
export const blocksSelectedInstance = createSelector(
  ...
  orm.createSelector((orm, selectedBlockId) => {
    if((selectedBlockId !== null) && (selectedBlockId !== undefined) && (selectedBlockId !== 0)) {
...
export const contractsSelectedInstance = createSelector(
  ...
  orm.createSelector((orm, selectedContractId) => {
    if((selectedContractId !== null) && (selectedContractId !== undefined) && (selectedContractId !== 0)) {
...
export const requestKeysSelectedInstance = createSelector(
  ...
  orm.createSelector((orm, selectedRequestKeyId) => {
    if((selectedRequestKeyId !== null) && (selectedRequestKeyId !== undefined) && (selectedRequestKeyId !== 0)) {
...
export const plantersOfDateSelector = createSelector(
  ...
  orm.createSelector((orm, selectedTallyDateId) => {
      if((selectedTallyDateId !== null) && (selectedTallyDateId !== undefined) && (selectedTallyDateId !== 0)) {
...
export const requestKeysOfDateSelector = createSelector(
  ...
  orm.createSelector((orm, selectedTallyDateId) => {
      if((selectedTallyDateId !== null) && (selectedTallyDateId !== undefined) && (selectedTallyDateId !== 0)) {
        return orm.Tally_Date.withId(selectedTallyDateId).request_keys.toModelArray( request_key => {
          const obj = Object.assign({}, request_key.ref)
          return obj;
        });
      }
...
export const contractsOfDateSelector = createSelector(
  ...
  orm.createSelector((orm, selectedTallyDateId) => {
      if((selectedTallyDateId !== null) && (selectedTallyDateId !== undefined) && (selectedTallyDateId !== 0)) {
        return orm.Tally_Date.withId(selectedTallyDateId).contracts.toModelArray( contract => {
...
export const blocksAvailableForDateSelector = createSelector(
  ...
  orm.createSelector((orm, selectedTallyDateId) => {
    /*
      if((selectedTallyDateId !== null) && (selectedTallyDateId !== undefined) && (selectedTallyDateId !== 0)) {
        return orm.Contract.tally_dates.filter({id: selectedTallyDateId}).blocks.toModelArray( block => {
          const obj = Object.assign({}, block.ref)
          return obj;
        })
      }
...
/*
export const contractsForDateExist = createSelector(
  ormSelector,
  state => state.selected_tally_date,
  orm.createSelector((orm, selectedTallyDateId) => {
    if((selectedTallyDateId !== null) && (selectedTallyDateId !== undefined) && (selectedTallyDateId !== 0)) {
      if (orm.Tally_Date.withId(selectedTallyDateId).contracts.exists()) {
