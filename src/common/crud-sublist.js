        ...
        <View>
          <View>
            <TouchableOpacity
              ...
              onPress={this._expandAnimation}>
                  <Text style={{color: 'white', fontSize: 16, fontWeight: '300', paddingLeft: 20}}>{`  ${this.props.related_element_name} ${this.props.listed_element_name}'s`}</Text>
                  <MaterialIcons
                    name={this.state.panel_open ? 'keyboard-arrow-right' : 'keyboard-arrow-down'}
                    size={30}
                    color='white'
                  />
            </TouchableOpacity>
          ...
          <View>
            <View style={[commonStyles.crudSubList, {height: this.state.panel_height}]}>
                <ScrollView
                  style={{backgroundColor: 'white', height: this.state.list_height, margin: 20, borderRadius: 5}}
