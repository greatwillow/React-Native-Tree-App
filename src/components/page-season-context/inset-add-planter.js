...
export default class InsetAddPlanter extends Component {
  constructor(props) {
    ...
    this.state = {
      id: this.props.id,
      first_name: this.props.setIntoUpdateMode
        ? this.props.plantersSelectedInstance.first_name
        : '',
      last_name: this.props.setIntoUpdateMode
        ? this.props.plantersSelectedInstance.last_name
        : '',
      name: this.props.setIntoUpdateMode ? this.props.plantersSelectedInstance.name : '',
      allocation_total: this.props.setIntoUpdateMode
        ? this.props.plantersSelectedInstance.allocation_total
        : '',
      additional_info: this.props.setIntoUpdateMode
        ? this.props.plantersSelectedInstance.additional_info
        : ''
    };
  }
