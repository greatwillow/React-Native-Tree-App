...
export default class InsetAddBlock extends Component {
    constructor(props) {
      ...
      this.state = {
        ...
        allocation_total: this.props.setIntoUpdateMode ? this.props.blocksSelectedInstance.allocation_total : '',
        additional_info: this.props.setIntoUpdateMode ? this.props.blocksSelectedInstance.additional_info : '',
      }
    }
