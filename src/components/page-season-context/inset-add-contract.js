...
export default class InsetAddContract extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      tree_count_total: this.props.setIntoUpdateMode
        ? this.props.contractsSelectedInstance.tree_count_total
        : '',
      additional_info: this.props.setIntoUpdateMode
        ? this.props.contractsSelectedInstance.additional_info
        : ''
    };
  }
