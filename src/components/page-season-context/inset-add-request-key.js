...
export default class InsetAddRequestKey extends Component {
    constructor(props) {
      ...
      this.state = {
        ...
        allocation_total: this.props.setIntoUpdateMode ? this.props.requestKeysSelectedInstance.allocation_total : '',
        additional_info: this.props.setIntoUpdateMode ? this.props.requestKeysSelectedInstance.additional_info : '',
      }
    }
