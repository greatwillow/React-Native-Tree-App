...
export default class TallyPlanters extends Component {
        ...
        return this.props.planters.planter_list.map((planter) => {
          return (
            <View key={planter.planterFullName}>
              <View style={styles.individualContainer}>
                <Text style={styles.planterNameTitle}>Tally for {planter.planterFullName}</Text>
              </View>
                <TallyIndividual {...this.props} />
            </View>
          );
      ...
      renderPickerList() {
        return this.props.planters.planter_list.map((planter) => {
          return (
              <Picker.Item key={planter.planterFullName} label={planter.planterFullName} value={planter.planterFullName} />
          );
        });
      }
      ...
      render() {
        return (
          <View>
            ...
            <View>
            {this.renderPlanterTally(this.state.planterPicked)}
            </View>
          </View>
        );
      }
