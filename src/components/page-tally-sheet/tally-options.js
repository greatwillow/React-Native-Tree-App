      ...
      <View style = {styles.container}>
        <View style= {styles.optionSelector}>
            <View style={styles.option}>
               <TouchableHighlight
                  onPress={this.props.optionSelected.bind(this, 'option1')}
                  >
            ...
            <View style={styles.option}>
               <TouchableHighlight
                onPress={this.props.optionSelected.bind(this, 'option2')}
                >
            ...
            <View style={styles.option}>
               <TouchableHighlight
                onPress={this.props.optionSelected.bind(this, 'option3')}
                >
