          ...
          <Image source={require('../../images/forest-top-fog.jpg')} style={{flex: 1, width: null, height: deviceHeight, resizeMode: 'cover'}}>
            <ScrollView>
              ...
              <CrudDaySubList
                  ...
                  removeElementFromRelationshipFunction = {this.props.removeContractFromTallyDate}
              ...
              <CrudDaySubList
                  ...
                  removeElementFromRelationshipFunction = {this.props.removeBlockFromTallyDate}
              ...
              <CrudDaySubList
                  ...
                  removeElementFromRelationshipFunction = {this.props.removeRequestKeyFromTallyDate}
              ...
              <CrudDaySubList
                  ...
                  removeElementFromRelationshipFunction = {this.props.removePlanterFromTallyDate}
